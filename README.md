...
The results of this projects are presented as a Javascript Interface that can be found in the folder website/results, or directly seen on this [http://nathanquinteiro.azurewebsites.net/ada/index.html](http://nathanquinteiro.azurewebsites.net/ada/index.html "Link")
